...
export async function trips_routes(app: FastifyInstance) {
    ...
    app.get('/:id', async (req, res) => {
        ...
        return prisma.trip.findUniqueOrThrow({ where: id }).catch(() => res.callNotFound())
    })
    ...
    app.put('/:id', async (req, res) => {
        ...
        return prisma.trip.update({ where: id, data: newTripData }).catch(() => res.callNotFound());
    })
    ...
    app.delete('/:id', async (req, res) => {
        ...
        return prisma.trip.delete({ where: id }).catch(() => res.callNotFound());
    })
}